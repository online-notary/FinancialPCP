...
const metadata = {
  title:
    "Home 19 || Personal Portfolio Reactjs Template | Freelancer & Developer Portfolio",
  description:
    "Personal Portfolio Reactjs Template | Freelancer & Developer Portfolio",
};
export default function HomePage19White() {
  return (
    <>
      <MetaComponent meta={metadata} />
      <BodyClassToggler
        classes={["spybody", "color-blue", "box-body", "tmp-white-version"]}
      />
      <Header2
