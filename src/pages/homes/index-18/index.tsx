...
const metadata = {
  title:
    "Home 18 || Personal Portfolio Reactjs Template | Freelancer & Developer Portfolio",
  description:
    "Personal Portfolio Reactjs Template | Freelancer & Developer Portfolio",
};
export default function HomePage18() {
  return (
    <div className="spybody index-ten primary-yellow">
      <>
                    ...
                    <div className="tmp-contact-about-inner">
                      <div className="thumbnail">
                        <img
                          loading="lazy"
                          alt="contact-img"
                          src="/assets/images/banner/banner-user-image-05.png"
                          width={525}
                          height={525}
                        />
                      </div>
