export const blogData = [
  {
    ...
    slug: "stand-out-from-the-crowd-with-a-professional-portfolio",
  },
  {
    id: 2,
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "elevate-your-brand-with-a-the-stunning-portfolios",
  },
  {
    id: 3,
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "elevate-your-brand-with-a-the-stunning-portfolio",
  },
];
...
export const blogData3 = [
  {
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "inspiring-the-world-one-project-at-a-time-for-the-woman",
  },
  {
    id: 2,
    animationOrder: "animation-order-2",
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "lets-bring-your-ideas-to-natural-contact-me-and-lets",
  },
  {
    id: 3,
    animationOrder: "animation-order-3",
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "each-one-showcase-my-approach-and-dedication-man",
  },
];
...
export const blogData4 = [
  ...
  },
  {
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "inspiring-the-world-one-project-at-a-time-for-the-man-and-woman",
  },
  {
    id: 3,
    animationOrder: "animation-order-3",
    ...
    description:
      "Aliquam eros justo, posuere loborti viverra lao ullamcorper posuere viverra .Aliquam eros justo, posuere Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper",
    slug: "each-one-showcases-my-approach-and-dedication-person",
  },
];
export const blogData5 = [
  {
    ...
    width: 410,
    height: 291,
    slug: "inspiring-the-world-one-project-at-a-time-for-the-men",
  },
  {
    id: 2,
    animationOrder: "animation-order-2",
  ...
  },
  {
    ...
    width: 411,
    height: 291,
    slug: "each-one-showcases-my-approach-and-dedication-man",
  },
  {
    id: 4,
    animationOrder: "animation-order-3",
    ...
    width: 410,
    height: 294,
    slug: "each-one-showcases-my-approach-and-dedication-woman",
  },
];
...
export const blogData6 = [
  {
    ...
    width: 410,
    height: 291,
    slug: "inspiring-the-world-one-project-at-a-time-for-human",
  },
  {
    id: 2,
    animationOrder: "animation-order-2",
    ...
    width: 410,
    height: 291,
    slug: "lets-bring-your-ideas-to-reality-contact-me-and-lets",
  },
  {
    id: 3,
    animationOrder: "animation-order-3",
    ...
    width: 411,
    height: 291,
    slug: "each-one-showcases-my-approach-for-dedication-man",
  },
];
export const blogData7 = [
  {
    ...
    width: 410,
    height: 294,
    slug: "lets-bring-your-ideas-to-real-contact-me-and-lets",
  },
  {
    id: 2,
    animationOrder: "animation-order-2",
    ...
    width: 410,
    height: 294,
    slug: "inspiring-the-world-one-project-at-a-time-for-the-people",
  },
  {
    id: 3,
    animationOrder: "animation-order-3",
    ...
    width: 410,
    height: 294,
    slug: "each-one-showcases-my-approach-to-dedication-man",
  },
];
...
export const posts = [
  {
    ...
    slug: "sustainable-solutions-designing-for-tomorrow",
  },
  {
    id: 2,
    ...
    slug: "technological-innovations-shaping-the-future",
  },
  {
    id: 3,
    ...
    slug: "adventure-awaits-exploring-the-great-outdoors",
  },
];
